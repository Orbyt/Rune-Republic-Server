...
public class Misc {
	...
	public static void print_debug(String str) {
		if (Server.isDebugModeEnabled())
			System.out.print(str); // comment this line out if you want to get
	...
	public static void printlnerr_debug(String str) {
		if (Server.isDebugModeEnabled())
			System.err.println(str);
	}

	public static void printerr_debug(String str) {
		if (Server.isDebugModeEnabled())
...
/*	public static int direction(int srcX, int srcY, int destX, int destY) {
	...
	// TODO sort out indendting tool lazy atm lol
